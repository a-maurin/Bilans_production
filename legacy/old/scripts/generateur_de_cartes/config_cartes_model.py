...
class GlobalConfig:
    ...
    # Par défaut on vise un projet placé dans Bilans_production/ref/sig,
    # mais ce chemin peut être surchargé par la variable d'environnement
    # CARTO_PROJECT_QGIS_PATH si besoin.
    project_qgis_path: str = r"E:\_Activité police\_BASES DE DONNEES\Bilans_production\ref\sig\sd21_tout.qgz"
    kit_ofb_path: str = r"E:\SIG\KIT_SIG_DIR9_2022\Composeur_mise_en_page_OFB"
