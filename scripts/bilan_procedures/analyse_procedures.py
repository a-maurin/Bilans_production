...
Utiliser à la place :
  python scripts/run_bilan.py --mode thematique --profil procedures_pve
  python scripts/bilan_thematique/run_bilan_thematique.py --profil procedures_pve

L'ancienne version est archivée dans old/scripts/bilan_procedures/.
"""
import sys
...
def run_bilan(date_deb: str, date_fin: str, dept_code: str) -> int:
    ...
    return run_engine("procedures_pve", date_deb, date_fin, dept_code)


def main() -> None:
    print("ATTENTION : ce script est déprécié. Utilisez :")
    print("  python scripts/run_bilan.py --mode thematique --profil procedures_pve")
