...
Utiliser à la place :
  python scripts/run_bilan.py --mode thematique --profil agrainage
  python scripts/bilan_thematique/run_bilan_thematique.py --profil agrainage

L'ancienne version est archivée dans old/scripts/bilan_agrainage/.
"""
import sys
...
def run_bilan(date_deb: str, date_fin: str, dept_code: str) -> int:
    ...
    return run_engine("agrainage", date_deb, date_fin, dept_code)


def main() -> None:
    print("ATTENTION : ce script est déprécié. Utilisez :")
    print("  python scripts/run_bilan.py --mode thematique --profil agrainage")
