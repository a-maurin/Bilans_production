...
def _generate_synthese_pdf(
    ...
    *,
    ...
    section_defs = [
        ...
        ("sec21", "2.1. Activité de police par thème du plan de contrôle"),
        ("sec22", "2.2. Résultat des contrôles au titre de la police administrative"),
        ("sec23", "2.3. Activité procédurale"),
        ("sec4", "3. Activité de police par type d'usager"),
        ("sec41", "3.1. Thème de contrôle par type d'usager"),
        ("sec42", "3.2. Résultat des contrôles par type d'usager"),
